...
<main>
    ...
    <div class="container" align="center" style="max-width: 800px">
        <div class="my-auto">
            <form id="review-id" action="includes/review-helper.php" method="post">
                <div class="container">
                    <i class="fa fa-paw fa-2x star-rev" data-index="1"></i>
                    <i class="fa fa-paw fa-2x star-rev" data-index="2"></i>
                    <i class="fa fa-paw fa-2x star-rev" data-index="3"></i>
                    <i class="fa fa-paw fa-2x star-rev" data-index="4"></i>
                    <i class="fa fa-paw fa-2x star-rev" data-index="5"></i>
                </div>
                ...
                <textarea name="review" id="review-text" cols="80"row="3" placeholder="Enter a comment.."></textarea>
